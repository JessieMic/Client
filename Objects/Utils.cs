...
namespace Objects
{
    ...
    {     //// "http://localhost:5163";// "https://pocserver20230311140030.azurewebsites.net";
        public static string m_BaseAddress =  "https://serverrooms.azurewebsites.net";//"http://localhost:5163";// "https://localhost:7038";//"https://serverrooms.azurewebsites.net";//https://localhost:7038";//""https://gameroomserverfinalproject.azurewebsites.net";//"https://localhost:7038";

...
namespace LogicUnit
{
    ...
    public class ServerContext
    {
        ...
        public static string k_BaseAddress = "https://finalprojectlobby.azurewebsites.net";// DeviceInfo.Platform == DevicePlatform.Android ? "http://10.0.2.2:5000" : "http://localhost:5163";

...
public partial class ScreenPlacementSelectingPage : ContentPage
{
    ...
    async Task initializePage()
    {
        ...
        UIbackground.WidthRequest = m_GameInformation.m_ClientScreenDimension.m_OurSize.Width;
            ...
            Application.Current.Dispatcher.Dispatch(async () =>
                {
                    ...
                    {
                        int a = ((m_GameInformation.m_ClientScreenDimension.SizeDTO.Height) / 12) / 3;
